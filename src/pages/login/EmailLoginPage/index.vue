<template>
  <div class="phone-login-container">
    <div class="phone-login-container-title">
      <h2 class="phone-login-container-title-significant">邮箱登录</h2>
      <h4 class="phone-login-container-title-subtitle">目前只支持QQ邮箱登录</h4>
    </div>

    <div class="login-form">
      <div class="login-form-inp phone">
        <h4>邮箱</h4>
        <input class="inp" type="text" placeholder="请输入邮箱" />
      </div>
      <div class="login-form-inp yzm">
        <h4>验证码</h4>
        <input class="inp" type="text" placeholder="请输入验验证码" />
      </div>
      ...
      <div class="other-login">
        ...
        <div class="other-login-btn-style">
          ...
          <div class="other-login-btn"><span class="iconfont" style="color:#f8be32;font-size: 28px;margin-left: -2px">&#xe85a;</span></div>
        </div>
      </div>
    </div>
  </div>
